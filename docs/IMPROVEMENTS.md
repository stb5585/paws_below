...
- Boundary walls now anchor at the shared edge of playable ground instead of the center of an outside grid cell, while internal obstacle walls remain centered on their collision cells. Cozy-light visibility now shades opaque floor surfaces and tints environment sprites instead of fading every tile independently; this prevents the scene background from reopening divergent seams at transparent and anti-aliased wall edges.
